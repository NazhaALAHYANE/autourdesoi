...
![Aperçu de la page d'accueil](Goeco/images/Accueil.png)
...
- Le projet est en développement : d'autres fonctionnalités (barre de recherche, responsive, intégration d'API) seront ajouté plus tard.
...
![Aperçu de la page des composteurs](Goeco/images/Composteurs-capture1.png)

![Aperçu de la page des composteurs](Goeco/images/Composteurs-capture2.png)